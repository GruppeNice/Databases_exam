...
INSERT INTO wards (ward_id, max_capacity, type) VALUES
                                                    (0x33333333333333333333333333333333, 20, 0), -- General ward
                                                    (0x44444444444444444444444444444444, 10, 1); -- ICU
...
INSERT INTO nurses (nurse_id, nurse_name, speciality, ward_ward_id) VALUES
                                                                           (0x99999999999999999999999999999999, 'Nurse Maria Lopez', 1, 0x33333333333333333333333333333333),
                                                                           (0xAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA, 'Nurse John Smith', 0, 0x44444444444444444444444444444444);
...
VALUES
    (0xDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD, '2023-12-01', 1, 'Routine checkup',
     0x55555555555555555555555555555555,
     0x99999999999999999999999999999999,
     0xBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB),

    (0xEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE, '2023-12-15', 0, 'Follow-up visit',
     0x66666666666666666666666666666666,
     0xAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA,
     0xCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC);
INSERT INTO diagnosis_patients (diagnosis_diagnosis_id, patients_patient_id) VALUES
...
VALUES
    ...
    (0xCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD, '2024-02-02', 'Gallbladder removal',
     0x66666666666666666666666666666666,
     0xCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC);
INSERT INTO wards_hospitals (hospitals_hospital_id, ward_ward_id) VALUES
